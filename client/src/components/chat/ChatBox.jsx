        ...
        <Stack gap={4} className='chat-box' /*style={{height: "100vh"}}*/>
            ...
            <Stack gap={3} className='messages'>
                {messages && messages.map((message, index) => (
                    <Stack key={index} className={`${message?.senderId === user?._id ? "message self align-self-end flex-grow-0 mb-5" :  "message align-self-start flex-grow-0 mb-5"}`} style={{color: "white"}}>
